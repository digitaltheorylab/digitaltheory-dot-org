...
#let events = (
  ...
  (
    ...
    title: "On the Four-Color Theorem and the Aesthetics of Computational
    Proof",
  ),
  (
  ...
  (
    ...
    title: "Book talk, From Deep Learning to Rational Machines"
  ),
  (
  ...
  (
    ...
    title: "Book talk, The Drone Sensorium",
  ),
  (
