...
- #link("https://www.upress.umn.edu/9781517919320/language-machines")[_Language Machines:
  Cultural AI and the End of Remainder Humanism_] (June 2025). Leif Weatherby.
...
=== DTL main
Our working group sessions are conducted throughout the academic year, bringing
together Lab members for discussions on readings and the theoretical dimensions
of computational practice. Past syllabi are available on request.
The working group is currently run by
#link("https://tylershoemaker.info/")[Tyler Shoemaker].
